...
public class PhysicsTest {
    ...
    @Test public void testAppOnInputParametrs() {
        ...
        try{
            ...
            jupiterPosition.x = Float.valueOf(in.next()).floatValue();
            jupiterPosition.y = Float.valueOf(in.next()).floatValue(); 
            jupiterPosition.z = Float.valueOf(in.next()).floatValue();
            voyagerPosition.x = Float.valueOf(in.next()).floatValue();
            voyagerPosition.y = Float.valueOf(in.next()).floatValue(); 
            voyagerPosition.z = Float.valueOf(in.next()).floatValue();
            directVector.x = Float.valueOf(in.next()).floatValue(); 
            directVector.y = Float.valueOf(in.next()).floatValue(); 
            directVector.z = Float.valueOf(in.next()).floatValue(); 
